    ...
    <Screen style={{ padding: 0 }}>
      <View style={styles.topBar}>
        <View style={styles.topBarLeft}>
          <Ionicons name="map-outline" size={18} color={colors.neon} />
      ...
      <View style={styles.mapWrap}>
        <AppMap
          ...
          markers={
            coords ? ([{ id: "me", coordinate: toLatLng(coords), pinColor: colors.neon }] satisfies AppMapMarker[]) : ([] as AppMapMarker[])
          }
        />
