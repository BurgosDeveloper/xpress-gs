      ...
      <ScrollView contentContainerStyle={{ padding: 16, paddingBottom: 24 }} keyboardShouldPersistTaps="handled">
        <View style={styles.headerWrap}>
          <View style={styles.headerRow}>
            <Ionicons name="time-outline" size={20} color={colors.neon} />
          ...
          <View style={styles.execRow}>
            ...
            >
              {driverPhoneLoading ? (
                ...
                <Ionicons name="logo-whatsapp" size={28} color={colors.neon} />
              )}
            ...
            >
              {driverPhoneLoading ? (
                ...
                <Ionicons name="call-outline" size={28} color={colors.neon} />
              )}
