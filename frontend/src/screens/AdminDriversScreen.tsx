...
export function AdminDriversScreen({ navigation }: Props) {
  ...
  const title = useMemo(() => `Ejecutivos (${drivers.length})`, [drivers.length]);
  ...
  async function load() {
    ...
    try {
      ...
      setError(e instanceof Error ? e.message : "No se pudo cargar ejecutivos");
    } finally {
      setLoading(false);
    }
  }
  ...
  async function deleteDriver(driverId: string) {
    ...
    Alert.alert("Eliminar ejecutivo", "Esto elimina al ejecutivo y toda su data relacionada. ¿Continuar?", [
      { text: "Cancelar", style: "cancel" },
      {
        text: "Eliminar",
        style: "destructive",
        onPress: async () => {
          ...
          try {
            ...
            setError(e instanceof Error ? e.message : "No se pudo eliminar el ejecutivo");
          } finally {
            setBusyId(null);
          }
        },
  ...
  return (
    <Screen>
      ...
      <ScrollView contentContainerStyle={styles.scroll}>
        <View style={styles.headerRow}>
          ...
          <View style={styles.headerRight}>
            <Pressable
              ...
              accessibilityLabel="Agregar ejecutivo"
            >
            ...
            <Card key={d.id} style={styles.card}>
              <View style={styles.cardTopRow}>
                ...
                <Pressable
                  ...
                  accessibilityRole="button"
                  accessibilityLabel="Editar ejecutivo"
                >
                  <Ionicons name="create-outline" size={18} color={colors.neon} />
                </Pressable>
              </View>
              ...
              <View style={styles.actionsRow}>
                ...
                >
                  <Ionicons
                    ...
                    size={18}
                    color={d.user?.isActive ? colors.danger : colors.neon}
                  />
                ...
                >
                  <Ionicons name="document-text-outline" size={18} color={colors.neon} />
                ...
                <Pressable
                  ...
                  style={({ pressed }) => [styles.actionBtn, pressed && styles.pressed]}
                  accessibilityRole="button"
                  accessibilityLabel="Eliminar ejecutivo"
                >
        ...
        {!loading && drivers.length === 0 ? <Text style={styles.muted}>No hay ejecutivos.</Text> : null}
      </ScrollView>
    </Screen>
  );
}
